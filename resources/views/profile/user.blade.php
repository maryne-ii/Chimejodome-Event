        ...
        <div class="bg-white h-[36rem] px-14 py-5 rounded-3xl shadow-lg">
            ...
            <div class="grid grid-cols-12 mt-3">
                <div class="col-span-3 flex flex-col justify-start items-center gap-10">
                    <img src="{{ env('APP_URL')."/".($user->profile_image) ? (env('APP_URL')."/".($user->profile_image))  : default_peson.jpeg}}" class="rounded-full h-48 w-48" alt="">
                ...
                <div class="col-span-9">
                    <div class="grid grid-cols-12 px-10 py-2 gap-3">
                        ...
                        <div class="col-span-8">
                            <input type="text" id="disabled-input-2" aria-label="disabled input 2" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{$user->year ? Auth::user()->year : '-'}}" disabled readonly>
                        </div>
                        <div class="col-span-4">
